...
class Config:
    ...
    MCTS_TRIGGER_PROB = 0.25
    MCTS_MAX_DEPTH = 3
    MCTS_BRANCHING = 2
    MCTS_FUTURE_DISCOUNT = 0.35
    MCTS_VRAM_DISABLE_GB = 13.5
    ...
    VRAM_EMERGENCY_LIMIT_GB = 17.5
    VRAM_PROACTIVE_CLEAR_GB = 13.0
    CACHE_CLEAR_INTERVAL_ITERS = 4
    ...
    MEDIUM_RUN_BATCH_SIZE = 8192
    MEDIUM_RUN_NUM_SIMULATIONS = 256
    MEDIUM_RUN_HIDDEN_DIM = 2048
