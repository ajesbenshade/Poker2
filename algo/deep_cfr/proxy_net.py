...
trained to mimic the current main advantage nets and can be broadcast to CPU
workers for faster strategy inference during traversal.
"""
    ...
    *,
    ...
    for step in range(steps):
        ...
        with ctx:
            ...
            diff = (proxy_adv.float() - teacher_adv) ** 2 * legal
